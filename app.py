...
.tbl-note{{font-size:12px;color:{C["muted"]};line-height:1.85;padding:14px 0 6px;
...
.stButton>button{{transition:all .25s ease!important;}}
.ftr-a{{transition:color .2s ease;}}
.ftr-social-icon{{transition:all .25s ease;}}
.ftr-social-icon:hover{{transform:translateY(-2px);}}
div[data-testid="stExpander"] div[data-testid="stExpanderDetails"]{{animation:fadeUp .3s ease both;}}
...
def section_title(text):
    st.markdown(f'<div style="font-family:Cormorant Garamond,serif;font-size:1.3rem;font-weight:700;color:{C["green"]};margin:44px 0 20px;padding-bottom:12px;border-bottom:2px solid {C["sand3"]};">{text}</div>', unsafe_allow_html=True)
...
def fig_note(what, why, read, extra=""):
    ...
    border-radius:0 8px 8px 0;padding:24px 28px;margin:20px 0 32px;box-shadow:0 2px 8px rgba(0,0,0,.04);">
...
# Sign out handled via ?signout=1 query param from header text
...
# ══════════════════════════════════════════════════════════════════
    ...
    if is_vol:
        page_banner("Volunteer Survey Entry","Submit Your Trash Counts","Thank you for volunteering!","https://sonoraninstitute.org/files/BHatch_02042018_1152-1600x900.jpg")
    else:
        page_banner("Field Data Entry","Survey Data Entry and Management","Submit new survey entries and manage existing records.","https://sonoraninstitute.org/files/BHatch_02042018_1152-1600x900.jpg")
    st.markdown('<div class="body fade-up">', unsafe_allow_html=True)
    if is_vol:
...
# ══════════════════════════════════════════════════════════════════
    ...
    c1, c2 = st.columns([3,2])
    with c1:
        st.markdown(f"""<div style="font-size:14px;color:{C['text']};line-height:2;">
    ...
    with _ab2:
        st.markdown(f"""
        <div style="font-size:14px;color:{C['text']};line-height:2;padding-top:8px;">
